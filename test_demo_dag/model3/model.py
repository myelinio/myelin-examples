...
class DeployModel3(object):
    ...
    def predict(self, features_dict):
        x_model1 = features_dict[self.model_key(features_dict, 'model-graph-deploymodel1')]
        x_model2 = features_dict[self.model_key(features_dict, 'model-graph-deploymodel2')]
