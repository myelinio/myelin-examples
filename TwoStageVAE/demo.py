...
def main():
    ...
    info_map = ({
        'fid_gen2': fid_gen2,
        'info': {'fid_gen2': fid_gen2, 'fid_gen1': fid_gen1}
    })

    config = {
        'second-dim': args.second_dim,
    }
    print("Config: %s" % config)

    metric_client = MetricClient()
    metric_client.post_update("fid_gen2", fid_gen2)
    metric_client.post_result(args.config_id, config, args.budget, fid_gen2, info_map)
...
if __name__ == '__main__':
    ...
    args.epochs = int(args.budget)
    args.epochs2 = args.epochs * 2
