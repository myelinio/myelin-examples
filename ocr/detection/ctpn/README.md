...
## Docker run
```bash
docker build -t  khsibr/ctpn . -f Dockerfile.train
docker run -v /media/ryadh/DATA4T/Ryadh_data/data/ctpn/VOC2007/:/app/ctpn/data/VOCdevkit2007/VOC2007 -v /tmp/ctpn_output:/app/ctpn/output khsibr/ctpn


s2i build .  myelinio/myelin-deployer-s2i-cuda10-all-py3:v0.1.4  myelinio/ctpn-predict:v0.1.0
