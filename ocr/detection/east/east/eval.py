...
tf.app.flags.DEFINE_string('checkpoint_path', '/root/EAST/pretrained_model/', '')
...
def resize_image(im, max_side_len=2400):
    ...
    elif min(resize_h, resize_w) <= 32:
        ratio = float(32) / resize_h if resize_h < resize_w else float(32) / resize_w
    else:
        ratio = 1.
