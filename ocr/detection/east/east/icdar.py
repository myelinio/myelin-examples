...
def get_batch(num_workers, **kwargs):
    try:
        ...
        max_queue_size = 10
        print('Generator use %s batches for buffering using %s, this may take a while, you can tune this yourself.' % (max_queue_size, num_workers))
