...
DEFAULT_CONFIG = {
    ...
    'splits': {
        'train': {
            'size': 100,
            'pattern': '/data/aocr/tfrecords/train/*'
        },
        'test': {
            'size': 100,
            'pattern': '/data/aocr/tfrecords/test/*'
        },
        'validation': {
            'size': 100,
            'pattern': '/data/aocr/tfrecords/validation/*'
        }
    },
    'charset_filename': '/app/aocr/charset_size=96.txt',
    'image_shape': (50, 600, 3),
    'num_of_views': 4,
